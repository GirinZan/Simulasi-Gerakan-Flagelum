...
// transform angle
// always put true in plots because real angles are drawn anticlockwise
var rangle;
var vangle;
function transAngle(rangle)
{
	...
	else if(rangle > 0 && rangle < 1) // lower half positive
	{
		vangle = 2-rangle;
	}else if(rangle > 1 && rangle < 2) // upper half positive
	{
		vangle = 2-rangle;
	}else if(rangle < 0 && rangle > -1) // lower half negative
	{
		vangle = -rangle;
	}else if(rangle < -1 && rangle > -2) // upper half negative
	{
		vangle = -rangle;
	}
	return vangle;
